...
<body dir="rtl" style="background-color: #fff;">
    <div style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
        <img style="width: 40%;height: auto;" src="{{asset('uploads/files/avatars/not-found.jpeg')}}">
        <h3 style="font-size: 80px;color: gray;margin: 0 0 20px;">عفوا</h3>
        <p style="font-size: 13px;margin: 15px 0 0;color: #7a7272db;">هذه الصفحة غير موجودة.</p>
    </div>
