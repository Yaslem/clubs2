<div>
    <div wire:loading.class="loading-status">
        <span class="cancel" wire:click="indexLocation()">رجوع</span>
        <div class="content-date " id="content-date">
            <form wire:submit.prevent="saveLocation()">
                ...
                <div>
                    ...
                    <textarea id="des" wire:model.debounce.10800000ms="des" name="des">{{$des}}</textarea>
                </div>
                <button type="submit">تعديل الموقع</button>
            </form>
        </div>
    </div>
