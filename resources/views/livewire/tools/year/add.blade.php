<div>
    <div wire:loading.class="loading-status">
        <span class="cancel" wire:click="indexYear()">رجوع</span>
        <div class="content-date">
            <form wire:submit.prevent="saveYear">
                <div>
                    <label for="name">السنة</label>
                    <input wire:model.debounce.10800000ms="year" id="name" type="date" name="start" @error('start') class="error" @enderror>
